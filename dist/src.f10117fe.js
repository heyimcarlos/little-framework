...
var Model = function () {
  ...
  Model.prototype.set = function (updateObj) {
...
var ApiSync = function () {
  function ApiSync(serverURL) {
    this.serverURL = serverURL;
  }

  ApiSync.prototype.fetch = function (id) {
    return axios_1.default.get(this.serverURL + "/" + id);
  };
  ...
  ApiSync.prototype.save = function (data) {
    ...
    if (!id) {
      return axios_1.default.post(this.serverURL, data);
    } else {
      return axios_1.default.put(this.serverURL + "/" + id, data);
    }
  };
...
var Attributes = function () {
  function Attributes(data) {
    ...
    this.data = data; // constraints limits the type = extends.
  ...
  Attributes.prototype.set = function (updateObj) {
...
var Collection = function () {
  function Collection(serverURL, deserialize) {
    this.serverURL = serverURL;
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.serverURL).then(function (res) {
...
var User = function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(serverURL));
  };

  User.userCollection = function () {
    User;
    return new Collection_1.Collection(serverURL, function (user) {
      return User.buildUser(user);
    });
  };

  User.prototype.isAdmin = function () {
    if (this.get('id') === 1) return true;else return false;
  };
...
var collection = User_1.User.userCollection();
